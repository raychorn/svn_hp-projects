...
public class UpdateNetworkAdapter extends PostAdapter<String, StringModel> {
    //private static final String SERVICE_NAME = "rest/networks";
    private static final String SERVICE_NAME = "services/net/updateNetworks";
    private String data;
    
    public UpdateNetworkAdapter () {
    	super();
    }

    public UpdateNetworkAdapter (String data) {
    	super();
    	this.data = data;
    }
