...
public class UpdateSwitchTypeAdapter extends PostAdapter<String, StringModel> {
    //private static final String SERVICE_NAME = "rest/Settings/DefaultSwitchType";
    private static final String SERVICE_NAME = "services/net/updateDefaultSwitchType";
    private String   data;
    
    public UpdateSwitchTypeAdapter () {
    	super();
    }

    public UpdateSwitchTypeAdapter (String data) {
    	super();
    	this.data = data;
    }
