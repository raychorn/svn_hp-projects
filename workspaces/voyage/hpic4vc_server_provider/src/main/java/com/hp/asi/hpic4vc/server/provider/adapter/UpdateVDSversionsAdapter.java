...
public class UpdateVDSversionsAdapter extends PostAdapter<String, StringModel> {   
    private static final String SERVICE_NAME = "services/net/vdsversions";
    private String   data;
    
    public UpdateVDSversionsAdapter () {
    	super();
    }

    public UpdateVDSversionsAdapter (String data) {
    	super();
    	this.data = data;
    }
