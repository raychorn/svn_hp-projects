...
public class UpdateClusterFirmwareAdapter extends PostAdapter<FirmwareJobsForClusterResult, FirmwareListOfJobsForClusterModel> {
	...
	public UpdateClusterFirmwareAdapter () {
	  	super();
	}
	
	public UpdateClusterFirmwareAdapter (String data, final String[] args, final String[] args1) {
	   super();
	   ...
	   this.hosts = new String[args1.length];
    ...
    private UpdateFirmwareComponentMessageModel formatMessageModel(UpdateFirmwareComponentMessageResult updateFirmwareComponentMessageResult){
    	...
    	updateFirmwareComponentMessageModel.setStatus(updateFirmwareComponentMessageResult.getStatus());
    	updateFirmwareComponentMessageModel.setMessage(updateFirmwareComponentMessageResult.getMessage());
    ...
    private JobsModel formatJobs(Jobs job){
		...
		if(job.getDescription()!=null){
			...
			jobsModel.setNoJobs("There are no firmware jobs on this host.");
		}
