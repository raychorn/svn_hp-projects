...
public class UpdateCredentialsAdapter extends PostAdapter<String, StringModel> {
    private static final String SERVICE_NAME = "settings/password";
    
    private String   data;
    
    public UpdateCredentialsAdapter () {
    	super();
    }

    public UpdateCredentialsAdapter (String data) {
    	super();
    	this.data = data;
    }
