...
public class SetPreferenceHostLevelAdapter extends PostAdapter<String, StringModel> {
    ...
    public SetPreferenceHostLevelAdapter () {
    	super();
    }

    public SetPreferenceHostLevelAdapter (String data) {
    	super();
    	this.data = data;    	
    }
