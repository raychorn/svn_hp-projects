...
public class SetPreferenceHostAdapter extends PostAdapter<String, StringModel> {
    //private static final String SERVICE_NAME = "rest/Settings/DefaultSwitchType";
    private static final String SERVICE_NAME = "services/net/setPreferenceHost";
    private String   data;   
    private String   clusterUuid; 
       
    public SetPreferenceHostAdapter () {
    	super();
    }

    public SetPreferenceHostAdapter (String data,String clusterUuid) {
    	super();
    	this.data = data;
	...
	protected String getWsUrl () throws InitializationException {
		...
		try {
			url= hostname + SERVICE_NAME + "/"+clusterUuid+"?filter="+ URLEncoder.encode(getQueryParameters(),"UTF-8");
