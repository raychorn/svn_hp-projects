...
public class UpdateHostPropertiesPasswordAdapter extends PostAdapter<String, StringModel> {
	
	 private static final String SERVICE_NAME = "settings/hostproperties";
	    
	 private String   data;
	 
	 public UpdateHostPropertiesPasswordAdapter () {
	   	super();
	 }

	 public UpdateHostPropertiesPasswordAdapter (String data) {
	    super();
	    this.data = data;
	}
