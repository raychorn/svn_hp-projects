...
public class StartRefreshCacheDataAdapter extends DataAdapter<RefreshResult, RefreshCacheModel> {

    private static final String SERVICE_NAME = "services/swd/startrefresh";

    public StartRefreshCacheDataAdapter () {
