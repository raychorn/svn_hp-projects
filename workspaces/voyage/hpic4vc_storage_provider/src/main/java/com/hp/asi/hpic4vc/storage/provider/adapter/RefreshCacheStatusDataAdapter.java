...
public class RefreshCacheStatusDataAdapter extends
        DataAdapter<RefreshResult, RefreshCacheModel> {

    private static final String SERVICE_NAME = "services/swd/refreshstatus";

    public RefreshCacheStatusDataAdapter () {
