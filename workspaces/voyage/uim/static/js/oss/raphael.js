...
(function () {
        ...
        setFillAndStroke = function (o, params) {
            ...
            if (params.opacity != null || 
                ...
                if (fill.on && params.fill) {
                    var isURL = params.fill.toString().match(ISURL);
                    if (isURL) {
                        fill.src = isURL[1];
                        fill.type = "tile";
                    } else {
    ...
    paperproto.binding = function(x, y) {
        return new Binding(x, y);
    };
    ...
    var Binding = function(x, y) {
        this.x = x;
        this.y = y;
    }
    Binding[proto].translate = function(dx, dy) {
        this.x += dx;
        this.y += dy;
        return this;
    }
    Binding[proto].getBBox = function() {
        return {
                x: this.x,
                y: this.y,
                width: 0,
    ...
    Set[proto][push] = function () {
        ...
        for (var i = 0, ii = arguments[length]; i < ii; i++) {
            item = arguments[i];
            if (item && (item.constructor == Element || item.constructor == Set || item.constructor == Binding)) {
    ...
    //CJF
    Set[proto].binding = function(name, x, y) {
        var b = new Binding(x, y);
        this[push](b);
