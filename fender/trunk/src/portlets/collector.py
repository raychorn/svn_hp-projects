...
class Collector:
    ...
    def collect_host_detail(self, force):   
        ...
        if self.vcntr :
            ...
            #self.hds = self.vcntr.get_hds_for_hcm(self.moref)
            #self.create_vdisk = self.vcntr.create_virtual_disk(self.moref)
            #self.transfer_file = self.vcntr.file_transfer_to_guest(self.moref, None, None, None, True, "", "", None)
